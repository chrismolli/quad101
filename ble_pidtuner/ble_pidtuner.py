...
def main():
    ...
    if(device.is_connected):
        ...
        def write_height():
            stdscr.addstr(21,0,'Enter height, use a point for decimal separation:',curses.color_pair(1))
            stdscr.refresh()
            curses.nocbreak()
            curses.echo()
            height=float(stdscr.getstr(22,0))
        ...
        def write_pcon():
            stdscr.addstr(21,0,'P-MODE: Enter (p),(i),(d) or (a).',curses.color_pair(1))
            stdscr.refresh()

            key = stdscr.getkey()
            if key == 'p':
                stdscr.clear()
                stdscr.addstr(21,0,'Enter KP, use a point for decimal separation:',curses.color_pair(1))
                stdscr.refresh()
                curses.nocbreak()
                curses.echo()
                val=float(stdscr.getstr(22,0))
                ...
                stdscr.clear()
                stdscr.addstr(21,0,'Enter TI, use a point for decimal separation:',curses.color_pair(1))
                stdscr.refresh()
                curses.nocbreak()
                curses.echo()
                val=float(stdscr.getstr(22,0))
                ...
                stdscr.clear()
                stdscr.addstr(21,0,'Enter TD, use a point for decimal separation:',curses.color_pair(1))
                stdscr.refresh()
                curses.nocbreak()
                curses.echo()
                val=float(stdscr.getstr(22,0))
                ...
                stdscr.clear()
                stdscr.addstr(21,0,'Enter TDD, use a point for decimal separation:',curses.color_pair(1))
                stdscr.refresh()
                curses.nocbreak()
                curses.echo()
                val=float(stdscr.getstr(22,0))
                ...
                stdscr.addstr(22,0,'Invalid choice, returning to update loop.',curses.color_pair(1))
                stdscr.refresh()

        def write_hcon():
            stdscr.addstr(21,0,'H-MODE: Enter (p),(i),(d).',curses.color_pair(1))
            stdscr.refresh()
        ...
        while True:
            stdscr.addstr(0,0,'Connected',curses.color_pair(2))
            stdscr.addstr(20,0,'Enter (q) to quit, (i) to insert a value or (s) to start/stop.',curses.color_pair(1))
            stdscr.refresh()
            print_constants()
            ...
            if key == 'q':
                ...
                stdscr.clear()
                stdscr.addstr(0,0,'Connected',curses.color_pair(2))
                stdscr.addstr(20,0,'Press (h) to change height, (1) to change p-con, (2) to change h-con',curses.color_pair(1))
                stdscr.refresh()
                ...
                if key == 'h':
                    ...
                    stdscr.addstr(21,0,'Invalid choice, returning to update loop.',curses.color_pair(1))
                    stdscr.refresh()
